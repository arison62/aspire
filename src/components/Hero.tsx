    ...
    <div>
      <section className="max-container mt-28">
        <div className="w-fit mx-auto space-y-5">
          <p className="text-6xl text-primaryColor text-center font-semibold">Multipurpose Website Templates</p>
          <p className="text-6xl text-primaryColor text-center font-semibold">That boost your Sales</p>
          <p className="text-slate-400 text-center">Empowering Your Financial Journey through Customized Asset Management Services</p>
        </div>
        <div className="mx-auto w-fit sm:w-full sm:max-w-md mt-12">
          <InputButton />
        </div>
